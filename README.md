...
<p align="center">
<img src=".github/jogo-da-adivinhacao.gif">
</p>
...
Manipulate the DOM, apply logic, events and callback functions.
...
You can view the layout of the project through [THIS LINK](https://www.figma.com/file/0TvLU4wpweISg0NQXGP4bi/Jogo-Adivinha%C3%A7%C3%A3o-(Copy)?node-id=0%3A1). You need an account on [Figma](https://figma.com) to access it.


## 🚀 Deploy

https://ricardodev10.github.io/jogo-da-adivinhacao/
